" Vim html-indent plugin, put this file in ~/.vim/indent/
" Taken from https://github.com/OCamlPro/ocp-indent/edit/rewind/tools/ocp-indent.vim
...
function! GetHtmlIndent(lnum)
  if s:buffer == bufnr('') && s:tick == b:changedtick && s:lnum < a:lnum && match(getline(s:lnum + 1, a:lnum - 1),'.') == -1
    ...
    let cmdline = "html-indent --numeric --lines " . a:lnum . '-'
